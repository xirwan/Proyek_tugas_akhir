...
<body>
    ...
    <div class="email-container">
        ...
        <div class="email-content">
            ...
            <p>Pengguna dengan Nama <strong>{{ $payment->parent->firstname . ' ' . $payment->parent->lastname }}</strong> telah mengunggah bukti pembayaran untuk kegiatan {{ $payment->activity->title }}.</p>
            <p>Silakan verifikasi bukti pembayaran tersebut.</p>
