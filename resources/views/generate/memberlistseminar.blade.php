<x-app-layout>
    ...
    <x-card>
        <x-slot name="header">
            List Peserta Seminar: {{ $seminar->name }}
        </x-slot>
            ...
            <div class="text-right mt-3">
                ...
                <form action="{{ route('generate.certificateseminar', $seminar->id) }}" method="POST" style="display: inline;">
                    @csrf
                    <button type="submit" class="btn btn-primary">
                        Generate Sertifikat
                    </button>
                </form>
                <a href="{{ route('generate.indexseminar') }}" class="btn btn-secondary">Kembali</a>
