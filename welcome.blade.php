            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        <a href="/" class="logo">
                            <img src="{{asset ('admintemp/img/logo.png')}}" alt="logo_GBI" width="50" height="50">
                        </a>
			...
			<div role="main" class="main">
				...
				<section id="intro" class="section section-no-border section-angled bg-light border-top-0 pt-0 pb-5 m-0">
					...
					<div class="container pb-2 h-100">
                        ...
                        <h1 class="mx-auto text-center pb-5">Cabang</h1>
					...
					<div class="container">
						<div class="row align-items-center justify-content-between">
							...
							<div class="col-lg-8 offset-lg-2 px-lg-0 text-center mb-5 mb-sm-4 mb-lg-0">
								<p class="font-weight-500 text-4 mb-0">Porto Admin has a huge variety of options and features to create your project, it has also a very solid based that is being improved and tested by professional developers since 2014.</p>
							</div>
						</div>
				...
				<section class="section section-no-border section-angled section-dark border-top-0 pb-0 m-0" style="background-repeat: no-repeat; background-color: #0169fe !important;" data-plugin-lazyload data-plugin-options="{'threshold': 500}" data-original="img/landing/reason_bg.png">
					...
					<div class="container pt-lg-4 pt-xl-5 mt-xl-5">
						<div class="row align-items-center justify-content-center pt-lg-5 mt-5">
							<div class="col-auto col-sm-12 col-lg-6 offset-lg-1 pt-5 mb-5">
								<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="500">
									<img src="img/lazy.png" data-plugin-lazyload data-plugin-options="{'threshold': 500, 'effect':'fadeIn'}" data-original="img/landing/porto_dots.png" width="154" height="146" class="position-absolute top-auto d-none d-lg-block" alt="6 reasons" data-plugin-float-element data-plugin-options="{'startPos': 'none', 'speed': 3, 'transition': true}" style="bottom: 204px; left: 70px;">
								</div>
								<div class="text-reasons pl-4 pl-sm-0">
									...
									<h3 class="text-color-light text-4 text-sm-6 text-md-9 text-lg-5 text-xl-8 py-sm-3 px-sm-5 px-lg-4 mt-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="950" data-appear-animation-duration="750">Porto <span class="highlighted-word highlighted-word-animation-1 highlighted-word-animation-1-light highlighted-word-animation-1-2 alternative-font-4 font-weight-extra-bold">Admin</span></h3>
								</div>
							</div>
							<div class="col-10 col-sm-12 col-lg-5 col-xl-4 pl-lg-4 pl-xl-5">
								<h2 class="text-color-light text-7 font-weight-semibold line-height-2 mb-2 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1150" data-appear-animation-duration="750">With Porto your satisfaction is guaranteed.</h2>
								<p class="custom-text-color-2 line-height-5 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1350" data-appear-animation-duration="750">We have selected the 6 top reasons to choose Porto Admin. Check below:</p>
							</div>
						</div>
							...
							<div class="col-lg-11">	
								<div class="row justify-content-center">
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600" data-appear-animation-duration="750">
										<img class="img-fluid mb-2" alt="Speed Performance" src="img/lazy.png" data-plugin-lazyload data-plugin-options="{'threshold': 500, 'effect':'fadeIn'}" data-original="img/landing/reason1.png">
										<div class="d-flex align-items-center mb-2">
											<span class="text-color-dark font-weight-extra-bold text-12 mr-2 line-height-1">1</span>
											<h4 class="d-flex flex-column font-weight-bold text-color-light text-5 mt-0 mb-0"><small class="font-weight-semibold positive-ls-2 line-height-1">OPTIMIZED FOR</small>Speed Performance</h4>
										</div>
										<p class="pr-5 custom-text-color-2">Choose Porto Admin and make your site at high performance. We know your project must the fast as possible.</p>
									</div>
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800" data-appear-animation-duration="750">
										<img class="img-fluid mb-2" alt="Speed Performance" src="img/lazy.png" data-plugin-lazyload data-plugin-options="{'threshold': 500, 'effect':'fadeIn'}" data-original="img/landing/reason2.png">
										<div class="d-flex align-items-center mb-2">
											<span class="text-color-dark font-weight-extra-bold text-12 mr-2 line-height-1">2</span>
											<h4 class="d-flex flex-column font-weight-bold text-color-light text-5 mt-0 mb-0"><small class="font-weight-semibold positive-ls-2 line-height-1">THE MOST</small>Solid and Tested Base</h4>
										</div>
										<p class="pr-5 custom-text-color-2">Porto has a very solid development base that has been improved since 2014 by our best developers.</p>
									</div>
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000" data-appear-animation-duration="750">
										<img class="img-fluid mb-2" alt="Speed Performance" src="img/lazy.png" data-plugin-lazyload data-plugin-options="{'threshold': 500, 'effect':'fadeIn'}" data-original="img/landing/reason3.png">
										<div class="d-flex align-items-center mb-2">
											<span class="text-color-dark font-weight-extra-bold text-12 mr-2 line-height-1">3</span>
											<h4 class="d-flex flex-column font-weight-bold text-color-light text-5 mt-0 mb-0"><small class="font-weight-semibold positive-ls-2 line-height-1">TOP DESIGNS CREATED BY</small>Usability Specialists</h4>
										</div>
										<p class="pr-5 custom-text-color-2">The designs of all pages and all demos included in Porto Admin were created by usability experts and modern designs standards.</p>
									</div>
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300" data-appear-animation-duration="750">
										<img class="img-fluid mb-2" alt="Speed Performance" src="img/lazy.png" data-plugin-lazyload data-plugin-options="{'threshold': 500, 'effect':'fadeIn'}" data-original="img/landing/reason4.png">
										<div class="d-flex align-items-center mb-2">
											<span class="text-color-dark font-weight-extra-bold text-12 mr-2 line-height-1">4</span>
											<h4 class="d-flex flex-column font-weight-bold text-color-light text-5 mt-0 mb-0"><small class="font-weight-semibold positive-ls-2 line-height-1">THE BEST</small>Customer Experience</h4>
										</div>
										<p class="pr-5 custom-text-color-2">4.85 average rating based on 2.5k+ review proves that Porto is loved by our customers.</p>
									</div>
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-appear-animation-duration="750">
										<img class="img-fluid mb-2" alt="Speed Performance" src="img/lazy.png" data-plugin-lazyload data-plugin-options="{'threshold': 500, 'effect':'fadeIn'}" data-original="img/landing/reason5.png">
										<div class="d-flex align-items-center mb-2">
											<span class="text-color-dark font-weight-extra-bold text-12 mr-2 line-height-1">5</span>
											<h4 class="d-flex flex-column font-weight-bold text-color-light text-5 mt-0 mb-0"><small class="font-weight-semibold positive-ls-2 line-height-1">WORKS PERFECTLY WITH</small>Porto Front-End Template</h4>
										</div>
										<p class="pr-5 custom-text-color-2">With Porto Front-End you can create your site with same design as the admin. Learn more in the next section.</p>
									</div>
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700" data-appear-animation-duration="750">
										<img class="img-fluid mb-2" alt="Speed Performance" src="img/lazy.png" data-plugin-lazyload data-plugin-options="{'threshold': 500, 'effect':'fadeIn'}" data-original="img/landing/reason6.png">
										<div class="d-flex align-items-center mb-2">
										...
										<p class="pr-5 custom-text-color-2">Lifetime regular update makes porto always "best" compared to other competitors.</p>
									</div>
								</div>
							</div>
						</div>
						<div class="text-center">
							<a href="https://themeforest.net/item/porto-admin-responsive-html5-template/8539472" class="btn btn-dark btn-rounded btn-modern btn-px-5 text-3 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="300" target="_blank">BUY PORTO ADMIN NOW!</a>
						</div>
					</div>
				</section>
				...
				<section class="section section-dark border-0 m-0">
					<div class="container">
						<div class="row justify-content-center mb-4">
							<div class="col-md-9 col-lg-7 text-center">
								<h5 class="font-weight-semibold positive-ls-2 text-4 text-primary mb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250" data-appear-animation-duration="750">POWERFUL AND COMPLETE</h5>
								<h2 class="text-color-light font-weight-bold text-9 mt-0 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600" data-appear-animation-duration="750">Advanced Plugins + Top Features</h2>
								<p class="font-weight-500 custom-text-color-1 color-inherit appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="850" data-appear-animation-duration="750">Create your admin using advanced included plugins and Porto's exclusive features. It’s incredibly easy and fun to build and mantain your admin design and content.</p>
							</div>
						</div>
						<div class="row row-gutter-sm justify-content-center pb-5">
							<div class="d-flex col-sm-6 col-lg-4 col-xl-3 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
								<div class="bg-color-dark-scale-4 rounded p-5">
									<i class="icon-bg icon-feature-1 mt-4"></i>
									<h4 class="font-weight-bold text-color-light text-4 mt-0 mb-2">Top Level Support</h4>
									<p class="font-weight-500 custom-text-color-1 text-3 color-inherit ls-0 mb-0">You can expect high technical reply within 24 hrs, average response time is 14 hrs. Customer satisfication is our main focus. You won't be alone using Porto Admin.</p>
								</div>
							</div>
							<div class="d-flex col-sm-6 col-lg-4 col-xl-3 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-appear-animation-duration="750">
								<div class="bg-color-dark-scale-4 rounded p-5">
									<i class="icon-bg icon-feature-2 mt-4"></i>
									<h4 class="font-weight-bold text-color-light text-4 mt-0 mb-2">100% Fully Responsive</h4>
									<p class="font-weight-500 custom-text-color-1 text-3 color-inherit ls-0 mb-0">Not only working fine on any screen resolutions, Porto Admin offers very beautiful layouts and avoid any heaviness for small resolutions.</p>
								</div>
							</div>
							<div class="d-flex col-sm-6 col-lg-4 col-xl-3 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600" data-appear-animation-duration="750">
								<div class="bg-color-dark-scale-4 rounded p-5">
									<i class="icon-bg icon-feature-3 mt-4"></i>
									<h4 class="font-weight-bold text-color-light text-4 mt-0 mb-2">Easy To Customize</h4>
									<p class="font-weight-500 custom-text-color-1 text-3 color-inherit ls-0 mb-0">Porto Admin was created to be very easy to edit and customize. The source code is organized to help any pro or beginner developer.</p>
								</div>
							</div>
							<div class="d-flex col-sm-6 col-lg-4 col-xl-3 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800" data-appear-animation-duration="750">
								<div class="bg-color-dark-scale-4 rounded p-5">
									<i class="icon-bg icon-feature-13 mt-4"></i>
									<h4 class="font-weight-bold text-color-light text-4 mt-0 mb-2">Optimized for Speed</h4>
									<p class="font-weight-500 custom-text-color-1 text-3 color-inherit ls-0 mb-0">Everything is oriented for high speed performance based in the best code standards.</p>
								</div>
							</div>
							<div class="d-flex col-sm-6 col-lg-4 col-xl-3 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" data-appear-animation-duration="750">
								<div class="bg-color-dark-scale-4 rounded p-5">
									<i class="icon-bg icon-feature-5 mt-4"></i>
									<h4 class="font-weight-bold text-color-light text-4 mt-0 mb-2">Retina Ready</h4>
									<p class="font-weight-500 custom-text-color-1 text-3 color-inherit ls-0 mb-0">Porto Admin works fine with any retina devices, we've fully tested Porto Admin on all retina resolutions including laptops and mobile devices.</p>
								</div>
							</div>
							<div class="d-flex col-sm-6 col-lg-4 col-xl-3 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-appear-animation-duration="750">
								<div class="bg-color-dark-scale-4 rounded p-5">
									<i class="icon-bg icon-feature-6 mt-4"></i>
									<h4 class="font-weight-bold text-color-light text-4 mt-0 mb-2">Bootstrap Based</h4>
									<p class="font-weight-500 custom-text-color-1 text-3 color-inherit ls-0 mb-0">Porto Admin is based on Bootstrap, the most popular CSS Framework for developing responsive and mobile-first projects.</p>
								</div>
							</div>
							<div class="d-flex col-sm-6 col-lg-4 col-xl-3 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600" data-appear-animation-duration="750">
								<div class="bg-color-dark-scale-4 rounded p-5">
									<i class="icon-bg icon-feature-11 mt-4"></i>
									<h4 class="font-weight-bold text-color-light text-4 mt-0 mb-2">Unlimited Colors &amp; Skins</h4>
									<p class="font-weight-500 custom-text-color-1 text-3 color-inherit ls-0 mb-0">You can configure any color you want, for entire site or certain sections using our exclusive style switcher.</p>
								</div>
							</div>
							<div class="d-flex col-sm-6 col-lg-4 col-xl-3 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800" data-appear-animation-duration="750">
								<div class="bg-color-dark-scale-4 rounded p-5">
									<i class="icon-bg icon-feature-10 mt-4"></i>
									<h4 class="font-weight-bold text-color-light text-4 mt-0 mb-2">CSS3 Animations</h4>
									<p class="font-weight-500 custom-text-color-1 text-3 color-inherit ls-0 mb-0">Porto Admin is always keen to update latest css 3 technologies, you can see nice and exclusive css3 animation effects through demos.</p>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="section section-dark section-angled border-0 pb-0 m-0" style="background-size: 100%; background-position: top;" data-plugin-lazyload data-plugin-options="{'threshold': 500}" data-original="img/landing/build_bg.jpg">
					<div class="section-angled-layer-top section-angled-layer-increase-angle bg-color-dark-scale-5" style="padding: 3rem 0;"></div>
					<div class="container text-center py-5 mt-5 mb-4">
						<h2 class="text-color-light font-weight-bold line-height-3 text-12 mt-5 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250" data-appear-animation-duration="750">Build your project with Porto Admin</h2>
						<h4 class="text-color-light font-weight-bold text-10 line-height-2 mb-4 pb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-appear-animation-duration="750">Purchase now. Only <span class="highlighted-word highlighted-word-animation-1 highlighted-word-animation-1-no-rotate highlighted-word-animation-1 highlighted-word-animation-1-light alternative-font-4 font-weight-bold text-3 light appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="800" data-appear-animation-duration="750">$16!</span></h4>
						<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="900" data-appear-animation-duration="750">
							<h4 class="font-weight-light text-color-light text-4 col-lg-6 px-0 offset-lg-3 fw-400 mb-5 opacity-8">Porto Admin has been available on ThemeForest since 2014 and is one of the top sellers with more than 7K+ sales.</h4>
						</div>
						<div class="col-12 px-0 pb-2 mb-4">
							<div class="row flex-column flex-lg-row justify-content-center">
								<div class="col-auto">
									<h5 class="font-weight-semibold text-color-light text-4 positive-ls-2 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1100" data-appear-animation-duration="750"><i class="fa fa-check"></i> SUPER HIGH PERFORMANCE</h5>
								</div>
								<div class="col-auto mx-5 my-2 my-lg-0">
									<h5 class="font-weight-semibold text-color-light text-4 positive-ls-2 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1400" data-appear-animation-duration="750"><i class="fa fa-check"></i> STRICT CODING STANDARDS</h5>
								</div>
								<div class="col-auto">
									<h5 class="font-weight-semibold text-color-light text-4 positive-ls-2 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1600" data-appear-animation-duration="750"><i class="fa fa-check"></i> FREE LIFETIME UPDATES</h5>
								</div>
							</div>
						</div>
						<a href="https://themeforest.net/item/porto-admin-responsive-html5-template/8539472" class="btn btn-dark btn-modern btn-rounded px-5 btn-py-3 text-4 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="1800" data-appear-animation-duration="750" target="_blank">BUY PORTO ADMIN NOW</a>
					</div>
					<div class="row border border-left-0 border-bottom-0 border-right-0 border-color-light-2">
						<div class="col-sm-4 text-center divider-left-border border-color-light-2 d-flex align-items-center justify-content-center py-4">
							<a href="http://www.okler.net/open-a-ticket/" class="text-decoration-none" target="_blank">
								<div class="icon-box">
									<i class="icon-bg icon-menu-2"></i>
									<h4 class="font-weight-500 text-color-light line-height-1 text-4 mt-0 mb-2">Support Center</h4>
								</div>
							</a>
						</div>
						<div class="col-sm-4 text-center divider-left-border border-color-light-2 d-flex align-items-center justify-content-center py-4">
							<a href="http://www.okler.net/" class="text-decoration-none" target="_blank">
								<div class="icon-box">
									...
									<h4 class="font-weight-500 text-color-light line-height-1 text-4 mt-0 mb-2">Online Documentation</h4>
								</div>
							</a>
						</div>
						<div class="col-sm-4 text-center divider-left-border border-color-light-2 d-flex align-items-center justify-content-center py-4 opacity-5">
							<a href="http://www.okler.net/" class="text-decoration-none" target="_blank">
								<div class="icon-box">
